<template>
  ...
  <figure id="videoContainer" data-fullscreen="false">
      ...
      <source :src="`https://unir-streaming.herokuapp.com/videos/video/${vidName}`" type="video/mp4">
			<track label="English" kind="captions" srcLang="en" :src="` https://unir-streaming.herokuapp.com/videos/video/${vidName}/caption`" default>
		</video>
    ...
    <!-- <div class="player">
        <video controls autoPlay crossOrigin="anonymous">
            <source :src="`http://ec2-52-15-137-157.us-east-2.compute.amazonaws.com:5000/videos/video/${vidName}`" type="video/mp4">
            <track label="English" kind="captions" srcLang="en" :src="`http://ec2-52-15-137-157.us-east-2.compute.amazonaws.com:5000/videos/video/${vidName}/caption`" default>
        </video> -->
        <!-- <div class="controls">
...
export default {
  ...
  mounted(){
    ...
    if (supportsVideo) {
      ...
      // Ocultar los controles por defaulr
      video.controls = false;

      // Mostrar los controles de video definidos
      videoControls.setAttribute('data-state', 'visible');

      // Obtener identificadores para botones y otros elementos.
      ...
      // Si el navegador no admite el elemento de barra de progreso, establezca su estado para un estilo diferente
      var supportsProgress = (document.createElement('progress').max !== undefined);
      if (!supportsProgress) progress.setAttribute('data-state', 'fake');

      // Revisar si el navegador soporta la  API de fullscreen
      var fullScreenEnabled = !!(document.fullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled || document.webkitSupportsFullscreen || document.webkitFullscreenEnabled || document.createElement('video').webkitRequestFullScreen);
      // Si el navegador no es compatible con la API de Fullscreen, oculte el botón de pantalla completa
